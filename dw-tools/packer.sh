...
if [ -f ../../dw-link/dw-server/x86_64-apple-darwin/dw-server ]; then
    VERSION=dw-link-tools-`../../dw-link/dw-server/x86_64-apple-darwin/dw-server -V`
...
for dir in ../../dw-link/dw-server/*; do
    if [ -d $dir ]; then
